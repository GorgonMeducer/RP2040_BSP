...
/*============================ TYPES =========================================*/
/*============================ GLOBAL VARIABLES ==============================*/
const spi_inst_t *SPI_PORT = spi1;

const uint8_t EPD_RST_PIN   = 12;
const uint8_t EPD_DC_PIN    = 8;
const uint8_t EPD_CS_PIN    = 9;
const uint8_t EPD_BUSY_PIN  = 13;
const uint8_t EPD_CLK_PIN   = 10;
const uint8_t EPD_MOSI_PIN  = 11;
...
__attribute__((used))
void __rp2040_bsp_use_epd_2in9d__(void)
{}
