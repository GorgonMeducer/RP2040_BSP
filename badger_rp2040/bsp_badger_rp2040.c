...
#include "../rp2040_epd_2in9d/e-Paper/EPD_2in9d.c"
#include "../rp2040_epd_2in9d/Config/DEV_Config.c"
...
const uint8_t EPD_CS_PIN    = 17;
const uint8_t EPD_CLK_PIN   = 18;
const uint8_t EPD_MOSI_PIN  = 19;
const uint8_t EPD_DC_PIN    = 20;
const uint8_t EPD_RST_PIN   = 21;
const uint8_t EPD_BUSY_PIN  = 26;
